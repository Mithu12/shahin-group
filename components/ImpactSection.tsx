        ...
        >
            <div className="relative bg-brand-light border-2 border-white/10 hover:border-brand-gold/50 transition-all duration-500 overflow-hidden">
                ...
                <div className="relative p-8 z-10">
                    {/* Icon */}
                    <motion.div
                        className="mb-6 inline-flex bg-white/5 group-hover:bg-brand-gold/10 transition-colors duration-300 p-4"
                        whileHover={{ scale: 1.05 }}
                        transition={{ type: "spring", stiffness: 300 }}
                    >
                        <div className="text-white/70 group-hover:text-brand-gold transition-colors duration-300">
                            {icon}
                        </div>
                    </motion.div>
                    ...
                    {/* Counter value */}
                    <motion.div
                        className="text-5xl md:text-6xl font-display font-bold mb-3 text-white group-hover:text-brand-gold transition-colors duration-300"
                        initial={{ scale: 0.5 }}
                    ...
                    {/* Label */}
                    <p className="text-white/70 font-body text-base font-medium uppercase tracking-wider">
                        {label}
                    </p>

                    {/* Animated underline */}
                    <motion.div
                        className="mt-4 h-0.5 bg-white/20 group-hover:bg-brand-gold/50 transition-colors duration-500 origin-left"
                        initial={{ scaleX: 0 }}
                ...
                >
                    ...
                    >
                        ...
                        <span className="relative inline-block">
                            <span className="relative z-10 text-brand-gold">Value</span>
                            <motion.span
                                initial={{ width: 0 }}
